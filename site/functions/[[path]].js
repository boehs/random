var manifest = {
	...
	{
		type: "script",
		href: "/assets/_...404_.697d9272.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.8bfcc67e.js"
	},
	{
		type: "style",
		href: "/assets/entry-client.e1c81f0f.css"
	}
],
	"/": [
	{
		type: "script",
		href: "/assets/index.848ff9be.js"
	},
	{
		type: "script",
		href: "/assets/entry-client.8bfcc67e.js"
...
function getAssetsFromManifest(manifest, routerContext) {
  ...
  const links = match.reduce((r, src) => {
    r[src.href] = src.type === "style" ? ssr(_tmpl$$5, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : src.type === "script" ? ssr(_tmpl$2$2, ssrHydrationKey(), ssrAttribute("href", escape(src.href, true), false)) : undefined;
    return r;
  }, {});
...
const _tmpl$$3 = ["<main", "><!--#-->", "<!--/--><h1>Hello world!</h1><p>Visit <a href=\"https://start.solidjs.com\" target=\"_blank\">start.solidjs.com</a> to learn how to build SolidStart apps.</p></main>"];
function Home() {
...
const _tmpl$$2 = ["<div", " style=\"", "\">", "</div>"];
function Grid(props) {
  const i = () => (props.grid.length - 1) / 2;
  return ssr(_tmpl$$2, ssrHydrationKey(), "width:" + "100%" + (";height:" + "700px") + (";display:" + "flex") + (";flex-direction:" + "column") + (";gap:" + `${5 - escape(Math.round(i() / 10), true)}px`) + (";border:" + "2px solid var(--sec)") + (";border-radius:" + "5px") + (";padding:" + "5px"), escape(createComponent(For, {
    get each() {
      return props.grid;
    },
    children: row => ssr(_tmpl$$2, ssrHydrationKey(), "display:" + "flex" + (";flex-grow:" + "1") + (";gap:" + `${5 - escape(Math.round(i() / 10), true)}px`), escape(createComponent(For, {
      each: row,
      children: item => ssr(_tmpl$$2, ssrHydrationKey(), "background-color:" + `${item ? "LightGray" : "white"}` + (";border-radius:" + `${5 - escape(Math.round(i() / 10), true)}px`) + (";height:" + "100%") + (";flex-grow:" + "1"), escape(item))
    })))
  })));
}

const _tmpl$$1 = ["<h1", ">Pow #4</h1>"],
  _tmpl$2$1 = ["<div", " class=\"toolbar\"><button>+</button><button", ">-</button><input type=\"number\"", " min=\"0\"><div class=\"chip\">", "</div></div>"],
...
function Counter() {
  ...
  return [ssr(_tmpl$$1, ssrHydrationKey()), createComponent(Grid, {
    get grid() {
      return grid();
    }
  }), ssr(_tmpl$2$1, ssrHydrationKey(), ssrAttribute("disabled", i() == 0, true), ssrAttribute("value", escape(i(), true), false), escape(grid().flat(1).filter(circle => circle).length)), ssr(_tmpl$3$1, ssrHydrationKey(), ssrAttribute("value", escape(i(), true), false))];
}
              ...
              return createComponent(ErrorBoundary, {
                get children() {
                  return [ssr(_tmpl$, ssrHydrationKey(), escape(createComponent(A, {
                    ...
                    children: (path, i) => ssr(_tmpl$3, ssrHydrationKey(), escape(createComponent(A, {
                      get href() {
                        return useLocation().pathname.split('/').slice(useLocation().pathname.split('/').length - i() - 1).join('/');
                      },
                      children: path
                    })))
